        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1">
              {facilityLabel} · {job.days_in_advance} Tage im Voraus{job.one_time ? ' · Einmalig' : ''}{job.debug ? ' · ' : ''}{job.debug && <span className="text-amber-400 text-xs font-medium">Debug</span>}
            </p>
          </div>
          {/* Toggle */}
          <button
